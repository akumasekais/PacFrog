...
public class GhostState_Idle : GhostState
{
    ...
    public override void OnEnter()
    {
        ...
        {
            Instance.GhostRenderer.materials[0] = Instance.DefaultMaterial;
        }
        Instance.Agent.isStopped = true;
        Instance.GhostRenderer.enabled = true;
    }
...
public class GhostState_Flee : GhostState
{
    ...
    public override void OnEnter()
    {
        ...
        {
            Instance.GhostRenderer.materials[0] = fleeMaterial;
        }
        else
        {
...
public class GhostState_Respawn : GhostState
{
    ...
    public override void OnEnter()
    {
        ...
        {
            Instance.GhostRenderer.materials[0] = respawnMaterial;
        }
        else
        {
        ...
        Instance.GhostRenderer.enabled = false;
